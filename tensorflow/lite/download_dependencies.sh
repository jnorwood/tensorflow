...
DOWNLOADS_DIR=tensorflow/lite/downloads
...
cp ${DOWNLOADS_DIR}/models/models/* tensorflow/lite/examples/ios/simple/data/
cp ${DOWNLOADS_DIR}/quantized_models/* tensorflow/lite/examples/ios/camera/data/
